...
For the embedding-based method, we present a review of attention mechanisms \cite{vaswani2017attention}, their application in knowledge graphs via Graph Attention Networks (GATs) \cite{velivckovic2017graph}, and the KBAT model \cite{nathani2019learning}. Our contribution in the deep learning approach includes a publicly accessible implementation and training process on the project homepage\footnote{\url{https://graphattentionnetwork.github.io/}}, with both the training code and model results openly provided.
